...
func initialize(nodes: Dictionary, refs: Dictionary) -> void:
	...
	cadence_button = nodes.get("cadence_button")
...
func _apply_contest_command_ui() -> void:
	...
	if cadence_button: cadence_button.visible = false
...
func _apply_collect_ui() -> void:
	...
	if cadence_button: cadence_button.visible = true
	play_minigames_button.visible = false
	skip_to_battle_button.visible = true
	...
	if should_disable_minigames:
		...
		if cadence_button: cadence_button.disabled = true
		...
		if cadence_button: cadence_button.disabled = false
...
func animate_phase_buttons() -> void:
	...
	if cadence_button: _fade_if_visible(btn_tween, cadence_button)
